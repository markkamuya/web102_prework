...
raisedCard.innerHTML = `$${totalAmountRaised.toLocaleString()} raised`;
...
const unfundedMessage = numUnfundedGames === 1
  ...
  : `There are ${numUnfundedGames} unfunded games.`;


// create a new DOM element containing the template string and append it to the description container
// create a message with the required information using template literals
const message = `A total of $${totalAmountRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfundedGames} games remain unfunded. We need your help to fund these amazing games!`;
